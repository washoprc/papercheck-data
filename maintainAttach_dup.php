              ...
              <TBODY>
                ...
                foreach($files as $file) {
                  if ($file != "." && $file != "..") {
                    ...
                    $_str .= $i+1 . ". <INPUT type='button' value='削除' onclick=location.href='./_maintainAttachDel_dup.php?tf=".$attachment."&fn=".$file."&so=" . $_staffOnly . "'>　";
                ...
                if (3-$i > 0) {
                  $_str = "<FORM method='POST' action='./_maintainAttachAdd_dup.php?tf=" . $attachment . "&so=" . $_staffOnly . "' enctype='multipart/form-data'>\n";
                  for ($j=3-$i; $j>0; $j--) {
                    $_str .= "<TR>\n<TD align='left' valign='top' class='hpb-cnt-tb-cell4'>";
