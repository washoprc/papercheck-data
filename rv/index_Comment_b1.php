...
// echo "GET=(".$_staffOnly_g."), POST=(".$_staffOnly_p.") -> staffOnly=(".$_staffOnly.")<br>";
  ...
  // PHPExcel ライブラリー
  include_once( dirname( __FILE__ ) . '/../ad/Classes/PHPExcel.php' );
  include_once( dirname( __FILE__ ) . '/../ad/Classes/PHPExcel/IOFactory.php' );
...
//                      $_msg .= "<TD class='".$_class."'>" . mb_strimwidth($eventTitle,0,36,'...',utf8) . "</TD>";
                      ...
                      $_msg .= "<INPUT type='button' name='action' value='審査' style='background-color:#b0c4de; border:1px solid #8C1F1F; border-radius: 0.3em;' onclick=location.href='./reviewComment.php?so=".$_staffOnly. "&id=".$_entryNo."'></TD>";
                      $_msg .= "</TR>\n";
                      echo $_msg;
                      break;
